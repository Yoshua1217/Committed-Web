...
interface CompletedActivityDetailModalProps {
  onRepeat?: (session: WorkoutSession) => Promise<void>; repeatLabel?: string;
...
export default function CompletedActivityDetailModal({ session, onClose, onDelete, onRepeat, repeatLabel }: CompletedActivityDetailModalProps) {
